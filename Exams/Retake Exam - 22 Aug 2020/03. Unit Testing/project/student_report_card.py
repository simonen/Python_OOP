...
rep = StudentReportCard('Pen4o', 3)
rep.grades_by_subject = {'Himiq': [3.5, 4.1], 'Muzika': [6, 3.44]}
rep.add_grade('matematika', 4)
rep.add_grade('matematika', 4)
print(rep.average_grade_by_subject())
print(rep.grades_by_subject)